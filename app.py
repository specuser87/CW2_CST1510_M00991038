...
# Initializing the database connection in the session
if 'db' not in st.session_state:
    st.session_state.db = DatabaseManager("DATA/intelligence_platform.db")
...
if not st.session_state.logged_in:
    ...
    - 🛡️ **Cybersecurity Dashboard** - Monitors and analyzes security incidents
    ...
    **Please use the login page in the sidebar to get started.**
    ...
    3. **Manage** records using CRUD operations
    ...
    with col4:
        st.metric("IT Tickets", stats['it_tickets'])  # ✅ Fixed typo

# Footer at the end of the page/web
st.markdown("---")
